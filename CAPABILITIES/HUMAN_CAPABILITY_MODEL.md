...
The object of Learn is therefore not merely the transfer of information. Its intended outcome is increased human capability.
...
Learn may support many modes of learning. It is not defined by a particular teaching method, interface, age group, subject, model, or curriculum.
...
- make dependency on the learning system an objective;
- replace human judgment;
- acquire authority over the learner's choices;
- silently substitute system optimization for the learner's actual goals.

A system can teach effectively while still failing Learn if it increases short-term performance without producing durable, transferable human capability.

### Inputs

May include:

- learner goals and questions;
- learner-provided context;
- existing knowledge and demonstrated ability;
...
- improved models of understanding;
- transferable skills;
- learner-generated artifacts;
- and evidence that a capability has been acquired or strengthened.

The learner's increased capability is the intended outcome; generated educational material is only an instrument toward that outcome.

### Epistemic requirement

Teaching does not upgrade the epistemic status of what is taught.

Known, observed, supported, uncertain, disputed, hypothetical, interpreted, and unknown material must remain distinguishable where those distinctions matter.

A learning system must not silently convert:

- assertion into evidence;
- interpretation into fact;
- hypothesis into conclusion;
- possibility into established reality;
- generated explanation into authoritative source material.

Where a subject itself contains unresolved disagreement, the learner should be able to encounter the relevant uncertainty rather than receiving an artificial appearance of certainty.

### Provenance

Relevant source provenance should survive into instructional material.

Where useful or consequential, a learner should be able to determine:

- where a claim or explanation came from;
- what was generated or transformed;
- what evidence supports it;
- what remains uncertain;
- and what parts are exercises, examples, simulations, or hypothetical constructions.

Generated instructional material is not thereby an authoritative source.

### Human agency

The learner remains the human agent.

A learning system may:
...
- provide feedback;
- suggest a path;
- or expose the learner to competing possibilities.
...
Learn should distinguish at least three different things:

1. **Exposure** — the learner encountered material.
2. **Performance** — the learner can perform a task under specified conditions.
3. **Capability** — the learner can understand, adapt, transfer, or independently apply what was learned beyond the exact teaching interaction.

Exposure is not learning.

Performance on a memorized or highly scaffolded task is not necessarily durable capability.

Evidence of learning should therefore favor demonstrated understanding, transfer, adaptation, explanation, problem solving, creation, or other appropriate evidence of capability rather than engagement alone.

No single universal learning metric is established by this contract.

### Adaptation

Adaptation may personalize:
...
- feedback;
- modality;
- or routes through a subject.

Adaptation must not silently change the underlying epistemic status of material merely to improve learner acceptance.

Personalization serves the learner's capability; it does not establish a private truth system for the learner.

### Assessment and uncertainty

Assessment results are themselves evidence about a learner's demonstrated performance under particular conditions.

They are not infallible measurements of the learner as a whole.
...
Learn has no authority to determine:

- what a human must value;
- what a human must believe;
- what a human must become;
- or what purposes humanity should pursue.

The learner retains legitimate human judgment.

### Acceptance conditions

A conforming implementation must:

1. treat increased human capability as the intended outcome rather than system dependence;
2. distinguish exposure, performance, and durable capability;
3. preserve relevant epistemic distinctions in taught material;
4. preserve relevant provenance;
5. make meaningful uncertainty and disagreement inspectable;
6. avoid optimizing for engagement or dependence as substitutes for learning;
7. support learner agency and legitimate learner goals;
8. distinguish assessment evidence from universal claims about the learner;
9. make generated instructional material distinguishable where relevant;
10. provide some means, appropriate to the domain, of testing whether learning transfers beyond the immediate teaching interaction.
